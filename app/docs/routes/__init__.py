...
# ``create_draft_handler``) into :mod:`app.docs.routes._upload`.  All
# three submodules are re-exported here so direct imports
...
# To intercept a submodule dependency, patch where it is USED:
#
...
#
# Same rule applies to any future submodule extracted in PR-D / PR-E.
