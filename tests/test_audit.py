...
class TestLogAction:
    ...
    @patch("app.auth.audit.get_connection")
    def test_log_action_inserts_row(self, mock_get_conn: MagicMock):
    ...
    @patch("app.auth.audit.get_connection")
    def test_log_action_with_none_user(self, mock_get_conn: MagicMock):
    ...
    @patch("app.auth.audit.get_connection")
    def test_log_action_with_detail(self, mock_get_conn: MagicMock):
    ...
    @patch("app.auth.audit.get_connection")
    def test_log_action_db_error_does_not_raise(self, mock_get_conn: MagicMock):
    ...
    @patch("app.auth.audit.get_connection")
    def test_log_action_none_detail_passes_none(self, mock_get_conn: MagicMock):
